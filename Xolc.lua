...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/vxyo/Loaders/refs/heads/main/OFFMUD2GRETTOLIB"))()
local Window = Library:CreateWindow("Xolc.lua", Vector2.new(300, 300), Enum.KeyCode.V)
